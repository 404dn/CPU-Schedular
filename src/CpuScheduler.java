...
public class CpuScheduler {
	...
	public void readFile() {
		...
		String Tburst = "";
		try {
			File file = new File("C:\\Users\\Adnan\\eclipse-workspace\\cpu scheduler\\Files\\Schedule_01.txt");
...
//		Event Evnt = new Event(EventNum ,textFieldTaskName.getText() ,Integer.valueOf(textFieldCpuBurst.getText()) ,Integer.valueOf(textFieldTaskPriority.getText()));
	...
	private void initialize() {
		...
		btnNewButton.setBounds(418, 467, 156, 27);
		...
		lblNewLabel.setBounds(418, 127, 156, 29);
		...
		lblSdfgsdfg.setBounds(418, 211, 156, 29);
		...
		lblSdfgsdfgsd.setBounds(418, 49, 156, 29);
		frame.getContentPane().add(lblSdfgsdfgsd);

		textFieldTaskName = new JTextField();
		textFieldTaskName.setBounds(418, 89, 156, 27);
		...
		btnReadFromFile.setBounds(418, 500, 156, 27);
		frame.getContentPane().add(btnReadFromFile);

		JScrollPane sp2 = new JScrollPane();
		sp2.setBounds(10, 228, 398, 150);
		...
		lblReadyQeue.setBounds(78, 198, 271, 27);
		frame.getContentPane().add(lblReadyQeue);

		JScrollPane sp3 = new JScrollPane();
		sp3.setBounds(10, 408, 398, 150);
		...
		lblT.setBounds(78, 380, 271, 27);
		frame.getContentPane().add(lblT);
		
		JButton btnClear = new JButton("Clear");
		btnClear.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnClear.setBounds(418, 436, 156, 27);
